                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" type="role" aria-describedby="emailHelp" placeholder="Enter Ur Status" name="role" required/>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputConfirmPassword" type="password" placeholder="Confirm password" name="password" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <button class="btn btn-primary" name="registrasi">Registrasi Akun</button>
                                        </form>
                                    </div>
